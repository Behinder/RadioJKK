...
CMakeFiles/encrypted-flash:
	/opt/local/bin/cmake -E echo "Error: The target encrypted-flash requires"
	/opt/local/bin/cmake -E echo "CONFIG_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT to be enabled."
	/opt/local/bin/cmake -E env "FAIL_MESSAGE=Failed executing target (see errors on lines above)" /opt/local/bin/cmake -P /Users/sebastian/src/esp-adf/esp-idf/tools/cmake/scripts/fail.cmake
